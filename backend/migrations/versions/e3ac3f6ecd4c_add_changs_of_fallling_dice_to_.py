"""add chance_of_falling_dice to statistic remove secondhalf
...
def upgrade():
    ...
    op.add_column('statistic', sa.Column('chance_of_falling_dice', sa.Float(), nullable=True))
    # ### end Alembic commands ###


def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_column('statistic', 'chance_of_falling_dice')
